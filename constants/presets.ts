...
export const PRESETS: Preset[] = [
  ...
  { id: 6, name: "Wear Pajamas", image: require("../assets/gifs/putting pajama.gif"), imageUrl: "preset_7_putting_pajama", hasBookGuide: true, hasMiniGame: false },
  ...
  { id: 8, name: "Fix the Bed", image: require("../assets/gifs/Fix the Bed.gif"), imageUrl: "preset_9_fix_the_bed", hasBookGuide: true, hasMiniGame: false },
  { id: 9, name: "Hair Care Time", image: require("../assets/gifs/Hair Care Time.gif"), imageUrl: "preset_10_hair_care_time", hasBookGuide: true, hasMiniGame: false },
  { id: 10, name: "Hand Blessing", image: require("../assets/gifs/Hand Blessing.gif"), imageUrl: "preset_11_hand_blessing", hasBookGuide: true, hasMiniGame: false },
  { id: 11, name: "Play with Friends", image: require("../assets/gifs/Play with Friends.gif"), imageUrl: "preset_12_play_with_friends", hasBookGuide: true, hasMiniGame: false },
  { id: 12, name: "Sweep the Floor", image: require("../assets/gifs/Sweep the Floor.gif"), imageUrl: "preset_13_sweep_the_floor", hasBookGuide: true, hasMiniGame: false },
];
