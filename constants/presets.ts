...
export const PRESETS: Preset[] = [
  ...
  { id: 6, name: "Bedtime Prep", image: require("../assets/gifs/putting pajama.gif"), imageUrl: "preset_7_putting_pajama" },
  { id: 7, name: "Go to Sleep", image: require("../assets/gifs/going to sleep.gif"), imageUrl: "preset_8_going_to_sleep" },
];
