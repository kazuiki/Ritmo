...
/**
 * Dedicated trampoline activity for Brush game so React Native receives a stable startup result.
 */
class BrushGodotActivityLauncher : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val launchIntent = Intent(this, BrushGodotActivity::class.java).apply {
    ...
    companion object {
        private const val REQUEST_CODE_GODOT = 9203
